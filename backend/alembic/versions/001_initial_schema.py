...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("emails", postgresql.JSONB(astext_type=sa.Text()), nullable=True, server_default=sa.text("'[]'")),
        sa.Column("phones", postgresql.JSONB(astext_type=sa.Text()), nullable=True, server_default=sa.text("'[]'")),
    ...
    op.create_table(
        ...
        sa.Column("version", sa.String(50), nullable=False, server_default=sa.text("'1.0'")),
